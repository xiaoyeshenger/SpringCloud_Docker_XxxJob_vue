package com.jsxa.iotPer.common.shiro;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/device/device/getGridInfoListByCommunityCode/**", "anon");
        filterChainDefinitionMap.put("/device/device/getDeviceByUUID/**", "anon");
        filterChainDefinitionMap.put("/accessAlarm/alarmInfo/waterMeterRecordDataStatisticsByDeviceId", "anon");
        filterChainDefinitionMap.put("/accessAlarm/alarmInfo/mattressRecordDataStatisticsByDeviceId", "anon");
        ...
        filterChainDefinitionMap.put("/accessAlarm/iot/**", "anon");
        filterChainDefinitionMap.put("/accessAlarm/image/upimg", "anon");
        ...
        //物联设备/视频设备
        filterChainDefinitionMap.put("/perception/**", "anon");
        //放行底层设备数据WebSocket
        filterChainDefinitionMap.put("/underlying/**", "anon");

        filterChainDefinitionMap.put("/bid/bidInfo/**", "anon");


        //(2).内部调用(微服务之间的调用)
        //--1.iotPer开头的代表内部调用(全部放行)
        filterChainDefinitionMap.put("/jingjia/**", "anon");
