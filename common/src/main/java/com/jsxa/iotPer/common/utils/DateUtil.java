package com.jsxa.iotPer.common.utils;
...
public class DateUtil {
    ...
    public static Map<String,Integer> getYearMonthDayByTimestamp(Long timestamp){
        Calendar calendar = Calendar.getInstance();
    ...
    * @Date: 2020-06-22 13:33
     ...
     * 判断今天是否为周末
     */
    public static void week(String[] args) {
        Calendar calendar = Calendar.getInstance();
     ...
     * 计算一个时间段内有多少个周末
     */
    public static int countWeekends(Long startTimeStamp, Long endTimeStamp) {

        //1.得到当前时间戳的年月日
        Map<String, Integer> yearMonthDayByTimestampStart = getYearMonthDayByTimestamp(startTimeStamp);
        Integer startYear = yearMonthDayByTimestampStart.get("year");
        Integer startMonth = yearMonthDayByTimestampStart.get("month");
        Integer startDay = yearMonthDayByTimestampStart.get("day");
        LocalDate start = LocalDate.of(startYear, startMonth, startDay);
        System.out.println("startYear:"+startYear+", startMonth:"+startMonth+", startDay:"+startDay);

        Map<String, Integer> yearMonthDayByTimestampEnd = getYearMonthDayByTimestamp(endTimeStamp);
        Integer endYear = yearMonthDayByTimestampEnd.get("year");
        Integer endMonth = yearMonthDayByTimestampEnd.get("month");
        Integer endDay = yearMonthDayByTimestampEnd.get("day");
...
/* public static void main(String[] args) throws Exception {
     ...
     long endTime = System.currentTimeMillis() + 3 * 24 * 60 * 60 * 1000L;
     System.out.println(countWeekends(startTime, endTime));
 }*/
