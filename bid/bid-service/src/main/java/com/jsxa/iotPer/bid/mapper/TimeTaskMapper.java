...
import static com.jsxa.iotPer.bid.mapper.TimeTaskDynamicSqlSupport.*;
...
public interface TimeTaskMapper {
    ...
    @Results(id="TimeTaskResult", value = {
        ...
        @Result(column="corn_Time", property="cornTime", jdbcType=JdbcType.BIGINT),
    ...
    default int insert(TimeTask record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(cornTime).toProperty("cornTime")
    ...
    default int insertSelective(TimeTask record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(cornTime).toPropertyWhenPresent("cornTime", record::getCornTime)
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<TimeTask>> selectByExampleOne() {
        return SelectDSL.selectWithMapper(this::selectOne ,id, type, projectId, projectName, jobId, xxljobadminAddress, corn,cornTime, handler, appName, createTime)
                .from(timeTask);
    }
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<TimeTask>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, type, projectId, projectName, jobId, xxljobadminAddress, corn,cornTime, handler, appName, createTime)
                .from(timeTask);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<TimeTask>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, type,  projectId, projectName, jobId, xxljobadminAddress, corn,cornTime, handler, appName, createTime)
                .from(timeTask);
    }
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(TimeTask record) {
        return UpdateDSL.updateWithMapper(this::update, timeTask)
                ...
                .set(cornTime).equalTo(record::getCornTime)
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(TimeTask record) {
        return UpdateDSL.updateWithMapper(this::update, timeTask)
                ...
                .set(cornTime).equalToWhenPresent(record::getCornTime)
