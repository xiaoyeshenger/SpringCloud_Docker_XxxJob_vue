package com.jsxa.iotPer.bid.util;

import cn.hutool.json.JSONUtil;
import com.alibaba.fastjson.JSONObject;
import com.jsxa.iotPer.bid.bo.po.XxlJobInfo;
...
/*    public static void main(String[] args) {
    ...
    private static void testUpdate(){
        ...
        //Integer code = XxlJobUtil.updateJob(14,"http://192.168.2.241:5092/xxl-job-admin/", corn, "updateProjectAuctionStatusGszJobHandler", "{'key':'123'}","测试zyzy"+"("+1762016871126663168L+")_修改项目竞拍状态为公示中定时任务","bid-service");
        Integer code = XxlJobUtil.updateJob(14,"http://192.168.2.230:9090/xxl-job-admin", corn, "updateProjectAuctionStatusGszJobHandler", "{'key':'123'}","测试zyzy"+"("+1762016871126663168L+")_修改项目竞拍状态为公示中定时任务","bid-service");
    ...
    private static void testAdd(){
        ...
        String code = XxlJobUtil.addJob("http://192.168.2.230:9090/xxl-job-admin", corn, "updateProjectAuctionStatusGszJobHandler", "{'key':'123'}","测试zyzy"+"("+1762016871126663168L+")_修改项目竞拍状态为公示中定时任务","bid-service");
