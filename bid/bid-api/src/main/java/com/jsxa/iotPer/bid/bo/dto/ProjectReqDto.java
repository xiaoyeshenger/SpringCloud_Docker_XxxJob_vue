...
/*    @ApiModelProperty(name = "quantityUnit", value = "数量单位(详见字典)", example = "123",dataType="Long")
    ...
    @Valid
    @ApiModelProperty(name = "productAuctionDataList", value = "产品拍卖数据列表", example = "",dataType="Array")
    @NotNull(message = "产品拍卖数据列表不能为空")
    private List<ProductAuctionDataReqDto> productAuctionDataList;
