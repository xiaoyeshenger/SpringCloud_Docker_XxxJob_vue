  ...
  <div>
    ...
    <el-row>
      ...
      <el-col :span="24">
        ...
        >
          ...
          <el-table-column prop="projectName" label="名称名称" align="center"></el-table-column>
          <el-table-column prop="projectQuantity" label="项目数量" align="center"></el-table-column>
          <el-table-column prop="curUnitPrice" label="当前出价单价" align="center"></el-table-column>
          <el-table-column prop="curTotalPrice" label="当前出价总价" align="center"></el-table-column>
          <el-table-column prop="userId" label="出价人ID" align="center"></el-table-column>
          <el-table-column prop="orgName" label="出价人名称(公司)" align="center"></el-table-column>
          <el-table-column prop="userMobile" label="出价人联系电话" align="center"></el-table-column>
          <el-table-column prop="bidTime" label="出价时间" align="center">
            <template slot-scope="scope">
              <span>{{ parseTime(scope.row.bidTime) }}</span>
            </template>
          </el-table-column>
          <el-table-column prop="bidStatus" label="拍卖状态(领先/出局)" align="center">
            <template slot-scope="scope">
              <span class="tag-js" v-if="scope.row.bidStatus">
                  {{scope.row.bidStatus?'启用':'停用'}}
              </span>
              <span class="tag-js" v-if="!scope.row.bidStatus">
                  {{scope.row.bidStatus?'启用':'停用'}}
              </span>
    ...
    <el-dialog title="添加" :visible.sync="addDialogVisible" width="30%" @close="addDialogClosed">
      ...
      <el-form :model="addForm" label-width="110px">
        ...
        <el-form-item label="名称名称" prop="projectName">
          <el-input v-model="addForm.projectName"></el-input>
        </el-form-item>
        <el-form-item label="项目数量" prop="projectQuantity">
          <el-input v-model="addForm.projectQuantity"></el-input>
        </el-form-item>
        <el-form-item label="当前出价单价" prop="curUnitPrice">
          <el-input v-model="addForm.curUnitPrice"></el-input>
        </el-form-item>
        <el-form-item label="当前出价总价" prop="curTotalPrice">
          <el-input v-model="addForm.curTotalPrice"></el-input>
        </el-form-item>
        <el-form-item label="出价人ID" prop="userId">
          <el-input v-model="addForm.userId"></el-input>
        </el-form-item>
        <el-form-item label="出价人名称(公司)" prop="orgName">
          <el-input v-model="addForm.orgName"></el-input>
        </el-form-item>
        <el-form-item label="出价人联系电话" prop="userMobile">
          <el-input v-model="addForm.userMobile"></el-input>
        </el-form-item>
        <el-form-item label="出价时间" prop="bidTime">
          <el-date-picker v-model="addForm.出价时间" type="date"
            value-format="timestamp" placeholder="选择日期" style="width: 420px">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="拍卖状态(领先/出局)" prop="bidStatus">
          <el-radio-group v-model="addForm.bidStatus">
...
import { add, deleteById, update, getById,listPage} from "@/api/bidRecord";
export default {
  data() {
    return {
      pageList: [], // 列表
